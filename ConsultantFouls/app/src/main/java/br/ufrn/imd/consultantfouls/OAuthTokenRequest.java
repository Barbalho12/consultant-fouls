...
public class OAuthTokenRequest {
    ...
    public Credential getTokenCredential(final Activity activity, String oauthServerURL, String clientId, String clientSecret, final Intent i){
        ...
        try {
            ...
            oauth.authorizeExplicitly("sise-id", callback, null);
            if(credential != null){
    ...
    public OAuthManager getOauth() {
        return oauth;
    }

    public void setOauth(OAuthManager oauth) {
        this.oauth = oauth;
    }
    ...
    public static OAuthTokenRequest getoAuthTokenRequest() {
        return oAuthTokenRequest;
    }

    public static void setoAuthTokenRequest(OAuthTokenRequest oAuthTokenRequest) {
        OAuthTokenRequest.oAuthTokenRequest = oAuthTokenRequest;
    }
